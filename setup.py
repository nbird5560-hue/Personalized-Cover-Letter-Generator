...
paths = ["writing_samples", "resumes", "output"]
uses = ["your example cover letters", "your résumé", "nothing, it will contain output .pdf and .txt files if selected"]
cwd = Path.cwd()
...
if style_index == 0:
    printss("Analyzing Writing Style")
